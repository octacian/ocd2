...
function ocd.register_gamemode(name, def)
...
function ocd.set_gamemode(player, gamemode)
...
function ocd.get_gamemode(player)
...
function ocd.get_gamemode_def(name)
...
-- [gamemode] Survival
ocd.register_gamemode("survival", {
  tab_group = "survival",
  hand = true,
  hand_capabilities = {
...
ocd.register_gamemode("creative", {
  tab_group = "creative",
  hand = true,
  range = 10,
